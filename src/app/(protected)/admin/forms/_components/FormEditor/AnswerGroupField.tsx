    ...
    <Autocomplete<GroupOption | typeof allAuthenticatedOption, true>
      ...
      renderInput={(params) => (
        <TextField
          ...
          helperText="指定したグループに所属するユーザーのみがこのフォームに回答できるようになります。「未サインインユーザー」を選ぶと、グループによる制限はできなくなり、サインインしていない訪問者も含め全員が回答できるようになります。なお、回答結果の公開設定を「公開」にした場合、ここで指定したグループのユーザーは回答結果も閲覧できるようになります。"
        />
      )}
